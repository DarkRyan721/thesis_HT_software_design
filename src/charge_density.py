...
for t in tqdm(range(timesteps), desc="Progreso"):
    ...
    s = move_particles(s_gpu, v_gpu, dt, q_m)
...
np.save("data_files/Electron_simulation.npy", all_positions)
print("Simulación guardada exitosamente en 'Electron_simulation.npy'")
